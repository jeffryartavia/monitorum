...
<body>
    <div class="container">
        <div class="card mt-4">
            <h5 class="card-header">Munitorum Field Manual - <a href="https://www.warhammer-community.com/warhammer-40000-downloads/" target="_blank">05/07/2023</a>
            </h5>
                ...
                <div class="row">
                    <div class="col col-xs-6">
                        <div class="text-center">
                            <a href="#" onclick="addNode()"><i class="bi bi-plus-circle-fill text-success" style="font-size: 50px; color: black;" id="addUnit"></i></a>
                            <p>Add Unit.</p>
                        </div>
                    </div>
                    <div class="col col-xs-6">
        ...
        <div class="row my-4 responsive">
            ...
            <div class="text-center col-sm-12 col-md-6 my-2">
                ...
                <a href="https://wa.me/50686169171" target="_blank" rel=noopener class="text-center">
                    <img src="assets/images/tattoo.jpg" class="rounded mx-auto d-block mb-3" alt="Tattoo" width="100%" style="max-width: 500px;">
                </a>
            </div>
        </div>
    </div>
    ...
    <script>
        var spaceMarinesFactionsList = ["BLACK TEMPLARS", "BLOOD ANGELS", "DARK ANGELS", "DEATHWATCH", "IMPERIAL FISTS", "IRON HANDS", "RAVEN GUARD", "SALAMANDERS", "SPACE WOLVES", "ULTRAMARINES", "WHITE SCARS"];
        ...
        const fetchUnitsByFactionName = async (factionName) => {
            ...
            if (spaceMarinesFactionsList.includes(factionSelect.value)) {
                unitsInFaction = factions.find(item => item.name === "SPACE MARINES");
            ...
            unitsInFaction = factions.find(item => item.name === factionSelect.value);
